$(function(){
    ...
    if(!Modernizr.input.placeholder){
        //this refers to input property of the Modernizr object, only executes if object returns false
...
//We are checking to see if it is false (the browser does not support the placeholder attribute); if so, we implement our polyfil
